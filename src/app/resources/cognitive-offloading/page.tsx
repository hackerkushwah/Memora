...
export const metadata = {
  ...
  description: "A comprehensive guide on " + "cognitive offloading: why you shouldn't rely on your brain" + " from the Memora experts.",
};
...
export default function ArticlePage() {
  const schema = {
    ...
    "@type": "Article",
    "headline": "Cognitive Offloading: Why You Shouldn't Rely on Your Brain",
    "author": {
      "@type": "Organization",
      "name": "Memora"
    },
        ...
        <article className="max-w-3xl mx-auto px-6">
          <header className="mb-12">
            <div className="flex items-center gap-4 text-sm font-medium text-zinc-500 mb-6">
              <span className="text-[#D4AF37]">Personal Knowledge</span>
              <span>•</span>
              <span>5 min read</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-serif font-black tracking-tight leading-tight mb-8">
              Cognitive Offloading: Why You Shouldn't Rely on Your Brain
            </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-zinc-300 prose-headings:text-white prose-a:text-[#D4AF37]">
            <p className="lead text-xl text-zinc-400 mb-8">
              This comprehensive article dives deep into the nuances of cognitive offloading: why you shouldn't rely on your brain, exploring the psychology, the technology, and the practical steps you can take today.
            </p>
