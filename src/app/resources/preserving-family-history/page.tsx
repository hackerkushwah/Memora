...
export const metadata = {
  ...
  description: "A comprehensive guide on " + "how to preserve your family history digitally" + " from the Memora experts.",
};
...
export default function ArticlePage() {
  const schema = {
    ...
    "@type": "Article",
    "headline": "How to Preserve Your Family History Digitally",
    "author": {
      "@type": "Organization",
      "name": "Memora"
    },
        ...
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-invert prose-lg max-w-none text-zinc-300 prose-headings:text-white prose-a:text-[#D4AF37]">
            <p className="lead text-xl text-zinc-400 mb-8">
              This comprehensive article dives deep into the nuances of how to preserve your family history digitally, exploring the psychology, the technology, and the practical steps you can take today.
            </p>
