...
export const metadata = {
  ...
  description: "A comprehensive guide on " + "how ai is changing the way we organize memories" + " from the Memora experts.",
};
        ...
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-invert prose-lg max-w-none text-zinc-300 prose-headings:text-white prose-a:text-[#D4AF37]">
            <p className="lead text-xl text-zinc-400 mb-8">
              This comprehensive article dives deep into the nuances of how ai is changing the way we organize memories, exploring the psychology, the technology, and the practical steps you can take today.
            </p>
