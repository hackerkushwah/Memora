      ...
      <div className="w-full max-w-4xl mx-auto px-6 relative z-10 flex flex-col space-y-24">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ScrollReveal delay={0.1} className="glassmorphism p-8 rounded-2xl flex flex-col items-center text-center space-y-4 hover:bg-white/[0.05] transition-colors">
            ...
            <ScrollReveal delay={0.2} className="glassmorphism p-8 rounded-2xl flex flex-col items-center text-center space-y-4 hover:bg-white/[0.05] transition-colors">
              <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mb-2">
            ...
            <ScrollReveal delay={0.3} className="glassmorphism p-8 rounded-2xl flex flex-col items-center text-center space-y-4 hover:bg-white/[0.05] transition-colors">
              <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mb-2">
