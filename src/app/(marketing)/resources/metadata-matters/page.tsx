export const metadata = {
  ...
  description: "A comprehensive guide on " + "why metadata matters more than the photo itself" + " from the Memora experts.",
};
...
export default function ArticlePage() {
  const schema = {
    ...
    "@type": "Article",
    "headline": "Why Metadata Matters More Than the Photo Itself",
    "author": {
      "@type": "Organization",
      "name": "Memora"
    },
        ...
        <article className="max-w-3xl mx-auto px-6">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-black tracking-tight leading-tight mb-8">
              Why Metadata Matters More Than the Photo Itself
            </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-zinc-300 prose-headings:text-white prose-a:text-[#D4AF37]">
            <p className="lead text-xl text-zinc-400 mb-8">
              This comprehensive article dives deep into the nuances of why metadata matters more than the photo itself, exploring the psychology, the technology, and the practical steps you can take today.
            </p>
