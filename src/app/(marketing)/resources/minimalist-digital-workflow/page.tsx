export const metadata = {
  ...
  description: "A comprehensive guide on " + "a minimalist digital workflow for creatives" + " from the Memora experts.",
};
...
export default function ArticlePage() {
  const schema = {
    ...
    "@type": "Article",
    "headline": "A Minimalist Digital Workflow for Creatives",
    "author": {
      "@type": "Organization",
      "name": "Memora"
    },
        ...
        <article className="max-w-3xl mx-auto px-6">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-black tracking-tight leading-tight mb-8">
              A Minimalist Digital Workflow for Creatives
            </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-zinc-300 prose-headings:text-white prose-a:text-[#D4AF37]">
            <p className="lead text-xl text-zinc-400 mb-8">
              This comprehensive article dives deep into the nuances of a minimalist digital workflow for creatives, exploring the psychology, the technology, and the practical steps you can take today.
            </p>
