        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              ...
              <a href="mailto:hello@memora.app" aria-label="Email" className="text-white/40 hover:text-white transition-colors">
          ...
          <div className="space-y-4">
            <h3 className="text-white font-medium tracking-wide">Platform</h3>
